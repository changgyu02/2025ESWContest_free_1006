...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/model', ['table_pkg/model/table_number_best.pt']),
    ...
    entry_points={
        'console_scripts': [
            ...
            'dirt_check_client_node = table_pkg.dirt_check_client_node:main',
            'table_align_node = table_pkg.table_align_node:main',
            'table_align_client_node = table_pkg.table_align_client_node:main',
            'drive_done_trigger = table_pkg.drive_done_trigger:main',
            'table_cleaning_node = table_pkg.table_cleaning_node:main',
